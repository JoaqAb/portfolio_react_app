  ...
  return (
    ...
    >
      <form method="post" action="https://getform.io/f/169c0493-d903-4484-a133-e7af93af7205" className="flex flex-col max-w-[600px] w-full">
        <div className="pb-8">
          <p className="text-4xl font-bold inline border-b-4 border-[#01c4e7] text-[#efefef]">
            Contact
          </p>
        ...
        <input className="p-2 bg-[#ccf3fa]" type="text" placeholder="Name" name="name" />
        <input className="my-4 p-2 bg-[#ccf3fa]" type="emial" placeholder="Email" name="email" />
        <textarea className="p-2 bg-[#ccf3fa]" name="message" rows="10" placeholder="Message"></textarea>
